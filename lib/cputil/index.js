...
var convertStarPrintMarkUp = function (_a) {
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          if (!text) return [2 /*return*/, Promise.reject(new Error('text'))]
          fileName = 'html-'.concat((0, uuid_1.v4)(), '.stm')
          tmpFilePath = path.join(__dirname, './tmp/'.concat(fileName))
          outputFilePath = path.join(
            __dirname,
            './output/'.concat(fileName.replace('.stm', '.bin'))
          )
          outputFormat =
            contentType !== null && contentType !== void 0
              ? contentType
              : StarContentType.STAR_VND_PRNT
          printerType =
            printerType !== null && printerType !== void 0 ? printerType : StarPrinterType.THERMAL_3
          cmd = ''
            .concat(CPUTIL_PATH, ' ')
            .concat(printerType, ' scale-to-fit decode ')
            .concat(outputFormat, ' ')
            .concat(tmpFilePath, ' ')
...
function readFile(filename) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      if (!filename) return [2 /*return*/, Promise.reject(new Error('filename'))]
      return [
        2 /*return*/,
